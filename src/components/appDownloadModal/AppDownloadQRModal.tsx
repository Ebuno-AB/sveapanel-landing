...
const AppDownloadQRModal: React.FC<AppDownloadQRModalProps> = ({ isOpen, onClose }) => {
  const getQRCodeUrl = () => {
  ...
  return (
    <div className="app-download-modal-overlay" onClick={onClose}>
      <div className="app-download-modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="app-download-modal-header">
          ...
          <h2 className="app-download-modal-title">
            Ladda ner SveaPanelen
          </h2>
