...
const GoogleIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M3 20.5V3.5C3 2.91 3.34 2.39 3.84 2.15L13.69 12L3.84 21.85C3.34 21.61 3 21.09 3 20.5Z" fill="#0F9D58"/>
    <path d="M16.81 15.12L6.05 21.34L14.54 12.85L16.81 15.12Z" fill="#FFCD40"/>
    <path d="M20.16 10.85C20.5 11.05 20.75 11.39 20.75 11.75S20.5 12.45 20.16 12.65L17.89 13.85L15.62 11.58L17.89 9.31L20.16 10.85Z" fill="#FF6138"/>
...
const ReviewsPlatform: React.FC<ReviewsPlatformProps> = ({ platform, rating, reviewCount, reviews }) => {
        ...
        <div className="platform-info">
          <div className="platform-details">
            ...
            <div className="platform-rating">
              ...
              <span className="rating-count">({reviewCount.toLocaleString('sv-SE')} omdömen)</span>
            </div>
          </div>
        </div>
      </div>
