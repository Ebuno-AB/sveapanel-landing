    ...
    <footer id="footer" className="modern-footer">
      <div className="footer-main">
        ...
        <div className="footer-right">
          <div className="social-icons">
            <a
              href="https://www.facebook.com/SveaPanelen/"
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/sveapanelenapp/"
              target="_blank"
              rel="noopener noreferrer"
              className="social-link"
            >
            ...
            <a
              href="https://www.tiktok.com/@sveapanelen"
              target="_blank"
              rel="noopener noreferrer"
              className="social-link"
            >
      ...
      <div className="footer-bottom">
        <div className="footer-links">
          ...
          <a
            href="https://pollflow.io"
            className="footer-link"
            target="https://pollflow.io"
            rel="noopener noreferrer"
          >
            PollFlow
          </a>
        ...
        <div className="footer-copyright">
          ...
          <span className="company-info">
            Powered by PollFlow - Flow Group AB
          </span>
        </div>
      </div>
    </footer>
