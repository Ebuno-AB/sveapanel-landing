...
import SocialBrowserWarning from "../components/ui/SocialBrowserWarning";
import BankIDButton from "../components/ui/BankIDButton";
    ...
    <div className="registration-page max-w-md mx-auto p-6">
      ...
      <div className="mt-6 text-center">
        <p className="text-sm text-gray-500">
          Har du inte BankID installerat? Ladda ner det från App Store eller
          Google Play.
        </p>
      </div>
    </div>
